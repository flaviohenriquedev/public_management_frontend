...
import {InfoContent} from "../page/style";
    ...
    return (
        <>
            ...
            <S.InfoContent opened={opened}>
                ...
                <S.InfoLine>
                    <Information title="Usuário de Criação" description="FLÁVIO HENRIQUE" />
                    <Information title="Data de Criação" description="27/11/2023" />
                </S.InfoLine>
                <S.InfoLine>
                    <Information title="Usuário de Alteração" description="FLÁVIO HENRIQUE" />
