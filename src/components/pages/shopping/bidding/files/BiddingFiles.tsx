    ...
    <PageLayout.Content>
      <form>
        <PageSection title="Cadastro de Arquivos">
          ...
          <LineContent>
            <LabelContainer
              title="Tamanho Máximo 5MB: Apenas arquivos no formato de PDF, vão ser considerados nos envios paras o COLARE!"
              notNull
            >
              <input
            ...
            <Table.Container>
              ...
              <Table.Body>
                <Table.Row>
                  ...
                  <Table.Value
                    value="COMPROVANTE DE PUBLICAÇÃO - JGC"
                    alignment="center"
                  />
                  <Table.Value
                    value="37e9f75c-f4c0-40b4-bfe4-795c8e4d6e80"
                    alignment="center"
                  />
